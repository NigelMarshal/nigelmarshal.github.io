...
Between these roles, I took a year to freelance, aiding small businesses in digital transformation. This endeavour sharpened my web development and content writing skills, keeping me synced with the evolving tech industry.

Armed with expertise in **React, Angular, RxJS, HTML5, CSS3, ES6/ES7 JavaScript** and more, I've also managed projects, led QA and User testing phases and represented companies as the development/product manager. My diverse experiences, from working with multicultural teams to handling diverse tech stacks, have shaped me into a versatile and adaptive professional.

I'm fuelled by continuous learning, always eager to assimilate emerging skills and technologies!
